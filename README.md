...
# SPY Mouse
This is an archive of the 2011 mobile game "SPY Mouse." 

A casual and strategy path-drawing styled game in which the player's objective is to collect cheeses while navigating obstacles and avoiding cats as well as obstacles by using mouse holes and pipes that the cats attempt to sabotage the player's objective.
